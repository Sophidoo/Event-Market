    ...
    return<>
        <div className="dashboardDetailsHeader">
            ...
            <h1>
                ...
                <span className="text-gray-600">Rentals</span> <ChevronRightIcon/>  <span className="text-gray-600">Details</span>
            </h1>
        ...
        <section className="dashboardTopRentalDetails">
            ...
            <div className="rightRentalDetails">
                <div className="rightRentalDetailsHeading">
                    <small className="text-gray-600">FURNITURE</small>
                    <h1>Banquet Chairs</h1>
                ...
                <h3 className="text-[#0B5850] font-medium">N300 <small className="text-gray-600 font-medium">per day</small></h3>
        ...
        <hr className="dashboardRentalDetailLine border-b-[1px] border-gray-200"/>
